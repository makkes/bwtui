...
ifeq ($(wildcard $(PRE_COMMIT_CONFIG_FILE)),)
	...
	$(Q) env SKIP=$(SKIP) pre-commit run -a --show-diff-on-failure --config $(PRE_COMMIT_CONFIG_FILE)
	$(Q) git fetch origin main && gitlint --ignore-stdin --commits origin/main..HEAD
